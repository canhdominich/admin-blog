  ...
  <div class="wrapper">
    ...
    <li class="dropdown user user-menu">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <span class="hidden-xs">Cảnh</span>
      </a>
      <ul class="dropdown-menu">
        <!-- User image -->
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active treeview">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="/admin/category"><i class="fa fa-circle-o"></i> Category </a></li>
          <li><a href="/admin/post"><i class="fa fa-circle-o"></i> Post</a></li>
          <li><a href="/admin/tag"><i class="fa fa-circle-o"></i> Tag</a></li>
...
<footer class="main-footer">
  ...
  <strong>Copyright &copy; 2018-2019 <a href="https://adminlte.io">Do Duc Canh</a>.</strong> All rights
  reserved.
</footer>
